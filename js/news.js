  ...
  "wuantum when",
  "sowwy for kiwwing youw famiwwy, it's time to weave youw mowtal fwesh *stabs you cutely* OwO 5x",
  "Nerf coordinate plane pls",
  "BREAKING NEWS: Square Root is still not fixed",
  "No, I think that mechanic's too overpowered, it'll cause inflatio-hahaha coordinate plane go BRRRRRRRRR-",
  "No, you shouldn't do that in a mechanic, that'll make the players quit playi-hahaha square root go BRRRRRRRRR-",
  "hhostify coming 2023",
  "When life gives you y's, you SACRIFICE THEM"
  ];
